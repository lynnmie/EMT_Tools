...
public class UTestCase2LLRAssigner implements Assigner{
	...
	public void assign(LPackage model, IObjectWorld db, Struct top)
		...
		final Set<LClassObject> llrs = db.getObjectGroup(LLR).getObjects();
		final Set<LClassObject> designs = db.getObjectGroup(Design).getObjects();
		//Set<LClassObject> functions = db.getObjectGroup(Function).getObjects();
