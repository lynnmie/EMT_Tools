...
public class TraceDesignAssigner implements Assigner{
	...
	public void assign(LPackage model, IObjectWorld db, Struct top)
		...
		LClass HLR = (LClass) model.getClassifierByName("Design");
	...
	protected static boolean traceable(LClassObject hlr){
		...
		try {
			LMultipleObject llrs = (LMultipleObject) hlr.get(hlr.getType().getFeatureByName("functions"));
