...
public class XMLDBWriter implements OGResourceWriter{
	OG_Directory resource;
	IObjectWorld cache;
	
	public XMLDBWriter(IObjectWorld cache) throws Exception{
	...
	public void write() throws Exception {
		...
		LPackage root = cache.getModelSpace();
		IModelWriter mwriter = new EcoreModelWriter("EcoreWriter");
		mwriter.setModel(root);
		mwriter.setOutputStream(new File(resource.getDirectory().getAbsoluteFile()+"\\"+"model.ecore"));
		mwriter.write();
		System.out.println("Model Written Complete...");
	}
