...
public class UniversalTreeNode extends OperatorTreeNode{
	...
	public UniversalTreeNode(JTree tree, String name) {
		super(tree, name, IconSet.OP_UNIVERSAL_ICON);this.op_init();
