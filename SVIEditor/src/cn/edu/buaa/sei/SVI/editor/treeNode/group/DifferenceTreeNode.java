...
public class DifferenceTreeNode extends BinaryOperatorTreeNode{
	...
	public DifferenceTreeNode(JTree tree, String name) {
		super(tree, name, IconSet.OP_DIFFERENCE_ICON);
		this.op_init();
	}
