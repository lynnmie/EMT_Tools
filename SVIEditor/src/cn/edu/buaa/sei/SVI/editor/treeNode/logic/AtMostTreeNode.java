...
public class AtMostTreeNode extends OperatorTreeNode{
	...
	public AtMostTreeNode(JTree tree, String name) {
		super(tree, name, IconSet.OP_ATMOST_ICON);
		this.op_init();
		
		UpperTreeNode lower = new UpperTreeNode(tree,"-1");
		this.add(lower);
