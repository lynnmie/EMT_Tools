...
public class ConjunctionImpl extends LogicOperatorImpl implements Conjunction{
	...
	protected ConjunctionImpl(LogicStruct[] operands,CompositeStruct container) throws Exception {
		super(container);
	...
	public void setOperands(Struct[] operands) throws Exception {
		...
		for(int i=0;i<operands.length;i++){
			if(!(operands[i] instanceof LogicStruct))
				throw new Exception("Operand of conjuunction must be LogicStructr");
