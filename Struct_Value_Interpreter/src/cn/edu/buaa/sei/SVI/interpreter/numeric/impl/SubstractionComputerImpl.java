...
import cn.edu.buaa.sei.SVI.interpreter.numeric.SubstractionComputer;
...
public class SubstractionComputerImpl implements SubstractionComputer{

	@Override
	public Number interpret(NumericStruct input) throws Exception {
		if(input==null)throw new Exception("Null input is invalid");
		if(!(input instanceof Substraction))throw new Exception("Substraction required");
		
		Substraction op = (Substraction) input;
